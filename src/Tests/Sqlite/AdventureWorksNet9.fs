// This code was generated by `SqlHydra.Sqlite` -- v3.6.0.
namespace Sqlite.AdventureWorksNet9
...
module Version =
    ...
    let ns = "Sqlite.AdventureWorksNet9"
...
type HydraReader =
    static member Read(reader: Microsoft.Data.SqlClient.SqlDataReader) : (unit -> 'T) =
        Hydration.buildRowReader<'T> Domain.ProviderType.Sqlite reader
